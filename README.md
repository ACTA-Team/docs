...
Important: Before using the API, create your Vault and DID at `https://demo.acta.build`. The Vault is required for on-chain storage, and the DID associates ownership and identity per W3C standards.
...
1. Create a Vault and DID at `https://demo.acta.build` for your organization or end user.
